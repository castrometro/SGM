// src/pages/ClienteDetalleNominaModuleDocs.jsx
...
/**
 * Página de documentación del módulo Detalle de Cliente de Nómina
 */
const ClienteDetalleNominaModuleDocs = () => {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold">Módulo Detalle de Cliente de Nómina</h1>
                <p className="text-sm text-gray-400">Documentación Técnica</p>
              </div>
            </div>
            <Link
              to="/dev/modules/cliente-detalle-nomina/demo"
            ...
            >
              {activeSection === 'overview' && (
                <div className="space-y-6">
                  <h2 className="text-3xl font-bold mb-4">👤 Módulo Detalle de Cliente de Nómina</h2>
                  <p className="text-gray-300 text-lg">
                    Vista completa de cliente con KPIs, información básica y acciones rápidas.
                  </p>
                  ...
                  <div className="bg-gray-900 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-300">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-green-400 mt-1">✓</span>
                        <span>KPIs del último cierre (empleados, líquido, haberes, descuentos)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-400 mt-1">✓</span>
                        <span>Botones de acción rápida (Dashboard, Cierres, Empleados)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-400 mt-1">✓</span>
...
{`nomina/cliente-detalle/
├── api/
│   └── clienteDetalle.api.js
├── components/
│   ├── ClienteInfoCard.jsx
│   ├── KpiResumenNomina.jsx
│   └── ClienteActionButtons.jsx
├── pages/
│   └── ClienteDetalleNominaPage.jsx
├── router/
│   └── ClienteDetalleNominaRouter.jsx
├── utils/
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-900 p-4 rounded-lg">
                      <h4 className="font-semibold text-teal-400 mb-2">ClienteDetalleNominaPage</h4>
                      <p className="text-sm text-gray-300">Página principal con validación de acceso y carga de datos con fallback</p>
                    </div>
                    
                    <div className="bg-gray-900 p-4 rounded-lg">
                      <h4 className="font-semibold text-teal-400 mb-2">ClienteInfoCard</h4>
                      <p className="text-sm text-gray-300">Card con información básica: nombre, RUT, industria, último cierre, estado</p>
                    </div>
                    
                    <div className="bg-gray-900 p-4 rounded-lg">
                      <h4 className="font-semibold text-teal-400 mb-2">KpiResumenNomina</h4>
                      <p className="text-sm text-gray-300">Grid de KPIs: total empleados, líquido, promedio, haberes, descuentos</p>
                    </div>

                    <div className="bg-gray-900 p-4 rounded-lg">
                      <h4 className="font-semibold text-teal-400 mb-2">ClienteActionButtons</h4>
                      <p className="text-sm text-gray-300">5 botones de acción: Dashboard, Crear Cierre, Historial, Empleados, Herramientas</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeSection === 'api' && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-900 p-4 rounded-lg">
                      <code className="text-teal-400">obtenerKpisNominaCliente(clienteId)</code>
                      <p className="text-sm text-gray-300 mt-2">GET /nomina/cierres/ + /informe/ - KPIs agregados del último cierre</p>
                    </div>
                    
                    <div className="bg-gray-900 p-4 rounded-lg">
                      <code className="text-teal-400">obtenerResumenNomina(clienteId)</code>
                      <p className="text-sm text-gray-300 mt-2">GET /nomina/cierres/resumen/&#123;clienteId&#125;/ - Resumen básico (fallback)</p>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-900 p-6 rounded-lg">
                    ...
                    <ol className="space-y-3 text-gray-300 list-decimal list-inside">
                      ...
                      <li>Valida que usuario.areas contenga 'Nomina' (normalizado, sin tilde)</li>
...
<Route path="/menu/clientes/:id/*" element={<ClienteDetalleNominaRouter />} />`}
                  </pre>

                  <div className="bg-yellow-900/30 border border-yellow-700 p-4 rounded-lg">
                    <p className="text-yellow-200 text-sm">
                      <strong>Nota:</strong> El módulo valida automáticamente el acceso y maneja fallback si no hay KPIs disponibles.
                    </p>
                  </div>
                </div>
              )}
...
export default ClienteDetalleNominaModuleDocs;
