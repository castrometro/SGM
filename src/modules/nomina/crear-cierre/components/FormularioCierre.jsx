// src/modules/nomina/crear-cierre/components/FormularioCierre.jsx
...
/**
 * Formulario para crear cierre de nómina
 */
const FormularioCierre = ({ clienteId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validar formulario
    const validacion = validarFormulario(periodo, tareas);
    ...
    try {
      ...
      const cierre = await crearCierreMensual(clienteId, periodo, tareas);
