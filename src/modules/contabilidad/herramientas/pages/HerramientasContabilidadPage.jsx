...
/**
 * HerramientasContabilidadPage - Página principal de herramientas de Contabilidad
 * 
 * Muestra herramientas organizadas por categorías con navegación por tabs.
 * Permite acceder a utilidades específicas de contabilidad.
 ...
 * @example
 * // En App.jsx
 * <Route path="/menu/contabilidad/tools/*" element={<HerramientasContabilidadRouter />} />
 */
const HerramientasContabilidadPage = () => {
  ...
  useEffect(() => {
    try {
      ...
      const tieneAccesoContabilidad = usuario.areas?.some(area => {
        const areaNombre = typeof area === 'string' ? area : area.nombre;
        return normalizar(areaNombre) === 'contabilidad';
      });
      
      setHasAccess(tieneAccesoContabilidad);
      
      if (!tieneAccesoContabilidad) {
        console.warn('Usuario no tiene acceso al área de Contabilidad');
      }
    } catch (error) {
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-8">
          ...
          <p className="text-gray-400 mb-6">
            No tienes permisos para acceder a las herramientas de Contabilidad.
          </p>
          <button
    ...
    <div className="text-white space-y-6">
      ...
      >
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-2">Herramientas de Contabilidad</h1>
          <p className="text-gray-400">
            Utilidades y recursos para la gestión integral de contabilidad
          </p>
        </div>
      </motion.div>
...
export default HerramientasContabilidadPage;
