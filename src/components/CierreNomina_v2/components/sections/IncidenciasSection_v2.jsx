...
import { AlertOctagon, ChevronDown, ChevronRight, Lock } from "lucide-react";

const IncidenciasSection_v2 = ({
  cierreId,
  enabled = false,
  ...
  return (
    <section className={`
      ...
      ${enabled ? 'border-red-500/30 bg-gray-800/50' : 'border-gray-600 bg-gray-800/30'}
    `}>
      <div 
        className={`
...
export default IncidenciasSection_v2;
