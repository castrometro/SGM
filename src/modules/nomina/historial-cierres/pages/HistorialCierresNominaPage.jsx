// src/modules/nomina/historial-cierres/pages/HistorialCierresNominaPage.jsx
...
import { obtenerCierresNominaCliente, obtenerCliente, obtenerUsuario } from "../api/historialCierres.api";
import { validarAccesoNomina, filtrarCierresPorEstado, calcularEstadisticas } from "../utils/historialCierresHelpers";
...
/**
 * Página de historial de cierres de nómina
 * Muestra todos los cierres de un cliente con filtros y estadísticas
 */
const HistorialCierresNominaPage = () => {
  ...
  const fetchCierres = useCallback(async (showRefresh = false) => {
    ...
    try {
      const res = await obtenerCierresNominaCliente(clienteId);
      setCierres(res);
    } catch (error) {
      ...
      <div className="flex items-center justify-center h-64">
        <div className="max-w-md mx-auto text-center p-8">
          ...
          <p className="text-gray-400 mb-6">
            No tienes permisos para acceder al historial de cierres de Nómina.
          </p>
          <button
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-2xl font-bold text-white">Historial de Cierres - Nómina</h1>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-16 px-4">
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 max-w-md text-center">
            ...
            <p className="text-sm text-gray-400">
              No hay cierres de nómina para {cliente?.nombre || 'este cliente'} aún.
            </p>
          </div>
        </div>
      </div>
...
export default HistorialCierresNominaPage;
