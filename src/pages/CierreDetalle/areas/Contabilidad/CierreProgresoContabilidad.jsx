...
const CierreProgresoContabilidad = ({ cierre, cliente }) => {
  ...
  useEffect(() => {
    const fetchEstados = async () => {
      try {
        ...
        console.error('Error al cargar estados de contabilidad:', error);
      }
    };
...
export default CierreProgresoContabilidad;
