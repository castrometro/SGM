...
import { FolderOpen, ChevronDown, ChevronRight, Lock } from "lucide-react";

const ArchivosAnalistaSection_v2 = ({
  cierreId,
  enabled = false,
  titulo = "Archivos del Analista",
  ...
  return (
    <section className={`
      ...
      ${enabled ? 'border-orange-500/30 bg-gray-800/50' : 'border-gray-600 bg-gray-800/30'}
    `}>
      <div 
        className={`
