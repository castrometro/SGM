 ...
 * @component
 * @param {Object} props
 * @param {Function} props.onLogin - Callback(correo, password, recordar) al hacer submit
 * @param {boolean} props.isLoading - Estado de carga durante autenticación
 * @param {string|null} props.error - Mensaje de error global a mostrar
 */
