...
const ClienteInfoCard = ({ cliente, resumen }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 rounded-xl shadow-2xl overflow-hidden border border-gray-700/50">
      ...
      <div className="bg-gradient-to-r from-teal-600/20 via-emerald-600/20 to-green-600/20 border-b border-gray-700/50 p-6">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-teal-500/20 to-emerald-500/20 border border-teal-500/30">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-3">
              ...
              <span className="inline-flex items-center gap-1.5 bg-teal-500/20 text-teal-300 text-xs font-medium px-3 py-1.5 rounded-full border border-teal-500/30">
                📊 Nómina
              </span>
            </div>
          </div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="group bg-gradient-to-br from-gray-700/40 to-gray-800/40 rounded-lg p-5 border border-gray-700/50 hover:border-gray-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
            <div className="absolute top-0 left-0 w-1 h-full rounded-l-lg bg-teal-500" />
            <div className="ml-2">
