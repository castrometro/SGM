// src/pages/ClienteDetalleNominaModuleDemo.jsx
import { useState } from 'react';
import { Link, Routes, Route, useNavigate, useParams } from 'react-router-dom';
import { ClienteDetalleNominaPage } from '../modules/nomina/cliente-detalle';
...
const DemoLayout = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (inputValue.trim()) {
      navigate(`/dev/modules/cliente-detalle-nomina/demo/${inputValue.trim()}`);
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-semibold text-gray-900 block">
                  DEMO: Módulo Detalle de Cliente de Nómina
                </span>
                <span className="text-xs text-gray-700">
                  Vista completa con KPIs y acciones rápidas
                </span>
              </div>
            </div>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Contenido - ClienteDetalleNominaPage */}
        <main className="flex-grow container mx-auto p-6 pt-32">
          <ClienteDetalleNominaPage />
        </main>
...
/**
 * Demo del módulo Detalle de Cliente de Nómina refactorizado
 * Muestra la página de detalle con Layout completo
 * Usa el usuario real del localStorage
 */
const ClienteDetalleNominaModuleDemo = () => {
  return (
    <Routes>
...
export default ClienteDetalleNominaModuleDemo;
