// Exportaciones de componentes de CierreDetalle
export { default as CierreAreaCompleto } from './CierreAreaCompleto';
export { default as CierreAreaRouter } from './CierreAreaRouter';
