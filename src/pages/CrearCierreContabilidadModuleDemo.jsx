// src/pages/CrearCierreContabilidadModuleDemo.jsx
...
const DemoLayout = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (inputValue.trim()) {
      navigate(`/dev/modules/crear-cierre-contabilidad/demo/${inputValue.trim()}`);
    }
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-semibold text-gray-900 block">
                  DEMO: Módulo Crear Cierre de Contabilidad
                </span>
                <span className="text-xs text-gray-700">
                  Formulario con validaciones y verificación de cierres existentes
                </span>
              </div>
            </div>
...
/**
 * Demo del módulo Crear Cierre de Contabilidad
 */
const CrearCierreContabilidadModuleDemo = () => {
  return (
    <Routes>
...
export default CrearCierreContabilidadModuleDemo;
