// src/modules/nomina/crear-cierre/pages/CrearCierreNominaPage.jsx
import { useEffect, useState } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { ArrowLeft } from 'lucide-react';
import { obtenerCliente, obtenerResumenNomina } from '../api/crearCierre.api';
import { validarAccesoNomina } from '../utils/crearCierreHelpers';
...
/**
 * Página para crear un nuevo cierre de nómina
 */
const CrearCierreNominaPage = () => {
  ...
  useEffect(() => {
    const cargarDatos = async () => {
      ...
      try {
        ...
        try {
          const resumenData = await obtenerResumenNomina(clienteId);
...
export default CrearCierreNominaPage;
