// src/pages/CapturaGastosModuleDemo.jsx
import { Link } from 'react-router-dom';
import { FiArrowLeft, FiCheckCircle } from 'react-icons/fi';
import { Header, Footer } from '../modules/shared/common';
import { DevModulesButton } from '../modules/shared/auth';
import { CapturaGastosPage } from '../modules/contabilidad/captura-gastos';

/**
 * Demo del módulo Captura Masiva de Gastos refactorizado
 * Muestra la herramienta con Layout completo
 * Usa el usuario real del localStorage
 */
const CapturaGastosModuleDemo = () => {
  return (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-semibold text-gray-900 block">
                  DEMO: Módulo Captura Masiva de Gastos
                </span>
                <span className="text-xs text-gray-700">
                  Herramienta de Contabilidad - Procesa gastos desde Excel
                </span>
              </div>
            </div>
...
export default CapturaGastosModuleDemo;
