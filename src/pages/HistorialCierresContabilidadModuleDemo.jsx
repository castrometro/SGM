// src/pages/HistorialCierresContabilidadModuleDemo.jsx
import { useState } from 'react';
import { Link, Routes, Route, useNavigate, useParams } from 'react-router-dom';
import { HistorialCierresContabilidadPage } from '../modules/contabilidad/historial-cierres';
...
const DemoLayout = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (inputValue.trim()) {
      navigate(`/dev/modules/historial-cierres-contabilidad/demo/${inputValue.trim()}`);
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-semibold text-gray-900 block">
                  DEMO: Módulo Historial de Cierres de Contabilidad
                </span>
                <span className="text-xs text-gray-700">
                  Filtros, estadísticas, cuentas nuevas y auto-refresh
                </span>
              </div>
            </div>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Contenido - HistorialCierresContabilidadPage */}
        <main className="flex-grow container mx-auto p-6 pt-32">
          <HistorialCierresContabilidadPage />
        </main>
...
/**
 * Demo del módulo Historial de Cierres de Contabilidad refactorizado
 */
const HistorialCierresContabilidadModuleDemo = () => {
  return (
    <Routes>
...
export default HistorialCierresContabilidadModuleDemo;
