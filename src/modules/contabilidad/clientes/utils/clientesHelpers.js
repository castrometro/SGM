// src/modules/contabilidad/clientes/utils/clientesHelpers.js
import { TIPO_USUARIO } from '../constants/clientes.constants';

/**
 * 🛠️ Utilidades para el módulo de Clientes de Contabilidad
 */
...
export const generarInfoDebug = (usuario, areaActiva, clientes, filtro, clientesFiltrados) => {
  return `
=== DEBUG: Carga de Clientes de Contabilidad ===
