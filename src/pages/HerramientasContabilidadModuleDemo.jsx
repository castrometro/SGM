// src/pages/HerramientasContabilidadModuleDemo.jsx
...
/**
 * Demo del módulo Herramientas de Contabilidad refactorizado
 * Muestra la página de herramientas con Layout completo
 * Usa el usuario real del localStorage
 */
const HerramientasContabilidadModuleDemo = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-semibold text-gray-900 block">
                  DEMO: Módulo Herramientas de Contabilidad
                </span>
                <span className="text-xs text-gray-700">
                  Utilidades y recursos para gestión contable
                </span>
              </div>
            </div>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Contenido - HerramientasContabilidadPage */}
        <main className="flex-grow container mx-auto p-6 pt-32">
          <HerramientasContabilidadPage />
        </main>
...
export default HerramientasContabilidadModuleDemo;
